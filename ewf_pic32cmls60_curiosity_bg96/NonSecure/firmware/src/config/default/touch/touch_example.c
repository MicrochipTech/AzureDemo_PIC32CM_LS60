...
extern BUTTON_PressData BUTTON_pressData;

uint8_t CAPTOUCHBUTTON_current = 0;
uint8_t CAPTOUCHBUTTON_last = 0;
...
void touch_status_display(void)
{
    ...
    CAPTOUCHBUTTON_last = CAPTOUCHBUTTON_current;
    CAPTOUCHBUTTON_current = key_status;

    if  ( (CAPTOUCHBUTTON_last == 0) && (CAPTOUCHBUTTON_current != 0) )
    {
        BUTTON_pressData.flag.btn = BUTTON_PRESS_TRUE;
